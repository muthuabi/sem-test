...
export default function Register()
{
    ...
    useEffect(()=>{
        ...
        const matchPass=()=>{
            if(!pass.value.test(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/))
                pass.setCustomValidity("Pasword should contain alphabets");
            else
        ...
        return(()=>{
            ...
            pass.removeEventListener("input",matchPass);
    ...
    <div className="login-container">
            <form onSubmit={handleSubmit} id="login" className="login-form">
                ...
                <div className="form-group">
                    ...
                    <input type="password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" id="password" name="password" className="form-control" required/>
